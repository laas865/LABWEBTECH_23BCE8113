// Q1 Create database named animal and select it
use('animal')

// Q2 Display all databases
db.adminCommand({ listDatabases: 1 })

// Q3 Create capped collection wild_animals and normal collection domestic_animals
db.createCollection("wild_animals",{capped:true,size:100000})
db.createCollection("domestic_animals")

// Q4 Insert 5 wild animal documents
...
// Q5 Insert 5 domestic animal documents
...
// Q6 Display all documents in both collections
db.getCollection("wild_animals").find({})
db.getCollection("domestic_animals").find({})

// Q7 Display only animal name and expenses
...
// Q8 Display domestic animals with particular lifespan 
db.getCollection("domestic_animals").find({life_span:15})

// Q9 Display wild animals under particular caretaker 
